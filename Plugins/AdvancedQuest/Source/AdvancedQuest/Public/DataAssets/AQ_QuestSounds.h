...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Advanced Quest | Sound ", meta = (EditCondition = "!bUseAdvancedSound", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Advanced Quest | Advanced Sound | Quest Start", meta = (EditCondition = "bUseAdvancedSound", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Advanced Quest | Advanced Sound | Quest End", meta = (EditCondition = "bUseAdvancedSound", EditConditionHides))
