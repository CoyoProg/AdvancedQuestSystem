...
// End Cross Module References
	...
	DEFINE_FUNCTION(UAQ_Quest::execOnNewDay)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnNewDay();
	...
	void UAQ_Quest::StaticRegisterNativesUAQ_Quest()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnEventRequirementChange", &UAQ_Quest::execOnEventRequirementChange },
			{ "OnLevelRequirementChange", &UAQ_Quest::execOnLevelRequirementChange },
			{ "OnNewDay", &UAQ_Quest::execOnNewDay },
	...
	struct Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics
	{
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAQ_Quest, nullptr, "OnEventRequirementChange", nullptr, nullptr, sizeof(Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::AQ_Quest_eventOnEventRequirementChange_Parms), Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAQ_Quest_OnEventRequirementChange_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/QuestSystem/AQ_Quest.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAQ_Quest, nullptr, "OnNewDay", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAQ_Quest_OnNewDay()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAQ_Quest_OnNewDay_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_AllObjectivesCompleted_MetaData[];
#endif
		static void NewProp_AllObjectivesCompleted_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_AllObjectivesCompleted;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted_MetaData[] = {
		{ "Category", "Advanced Quest | Quest" },
		{ "ModuleRelativePath", "Public/QuestSystem/AQ_Quest.h" },
	};
#endif
	void Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted_SetBit(void* Obj)
	{
		((UAQ_Quest*)Obj)->AllObjectivesCompleted = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted = { "AllObjectivesCompleted", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UAQ_Quest), &Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAQ_Quest_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAQ_Quest_Statics::NewProp_AllObjectivesCompleted,
	...
	struct Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_541202533(TEXT("/Script/AdvancedQuest"),
		Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_QuestSystem_AQ_Quest_h_Statics::EnumInfo));
