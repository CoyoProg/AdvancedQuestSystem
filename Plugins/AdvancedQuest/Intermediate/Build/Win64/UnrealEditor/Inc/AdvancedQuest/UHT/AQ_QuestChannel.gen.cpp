...
// End Cross Module References
	...
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::NewProp_PlayerLevel = { "PlayerLevel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_AdvancedQuest_eventLevelRequirementChangedDelegate_Parms, PlayerLevel), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AdvancedQuest, nullptr, "LevelRequirementChangedDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::_Script_AdvancedQuest_eventLevelRequirementChangedDelegate_Parms), Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AdvancedQuest_LevelRequirementChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics
	{
		struct _Script_AdvancedQuest_eventSpecialEventTriggerDelegate_Parms
		{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::NewProp_SpecialEvent = { "SpecialEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_AdvancedQuest_eventSpecialEventTriggerDelegate_Parms, SpecialEvent), Z_Construct_UClass_UAQ_SpecialEventData_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::NewProp_SpecialEvent,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/PlayersChannels/AQ_QuestChannel.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AdvancedQuest, nullptr, "SpecialEventTriggerDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::_Script_AdvancedQuest_eventSpecialEventTriggerDelegate_Parms), Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_AdvancedQuest_SpecialEventTriggerDelegate__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::NewProp_QuestUpdate = { "QuestUpdate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AQ_QuestChannel_eventOnQuestStateChanged_Parms, QuestUpdate), Z_Construct_UClass_UAQ_Quest_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::NewProp_QuestState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::NewProp_QuestState = { "QuestState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AQ_QuestChannel_eventOnQuestStateChanged_Parms, QuestState), Z_Construct_UEnum_AdvancedQuest_EAQ_QuestState, METADATA_PARAMS(nullptr, 0) }; // 1583766727
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAQ_QuestChannel, nullptr, "OnQuestStateChanged", nullptr, nullptr, sizeof(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::AQ_QuestChannel_eventOnQuestStateChanged_Parms), Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestStateChanged_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::NewProp_QuestUpdate = { "QuestUpdate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AQ_QuestChannel_eventOnQuestUpdate_Parms, QuestUpdate), Z_Construct_UClass_UAQ_Quest_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAQ_QuestChannel, nullptr, "OnQuestUpdate", nullptr, nullptr, sizeof(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::AQ_QuestChannel_eventOnQuestUpdate_Parms), Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAQ_QuestChannel_OnQuestUpdate_Statics::Function_MetaDataParams)) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAQ_QuestChannel_Statics::NewProp_QuestWidgets = { "QuestWidgets", nullptr, (EPropertyFlags)0x001000000008081d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAQ_QuestChannel, QuestWidgets), Z_Construct_UClass_UAQ_BookQuest_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAQ_QuestChannel_Statics::NewProp_QuestWidgets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAQ_QuestChannel_Statics::NewProp_QuestWidgets_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAQ_QuestChannel_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAQ_QuestChannel_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAQ_QuestChannel_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_PlayersChannels_AQ_QuestChannel_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_PlayersChannels_AQ_QuestChannel_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_PlayersChannels_AQ_QuestChannel_h_2889092307(TEXT("/Script/AdvancedQuest"),
		Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_PlayersChannels_AQ_QuestChannel_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QuestPlugin_Plugins_AdvancedQuest_Source_AdvancedQuest_Public_PlayersChannels_AQ_QuestChannel_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
